...
Annotator.Editor = (function(superClass) {
    ...
    Editor.prototype.show = function(event) {
        ...
        this.element.find('.comment-labels').html('');    // clear out any previous labels
        var res = this.annotation.uri + '_' + this.annotation.id;
        this.element.find('.annotator-listing').append('<div class="comment-labels">' + displayLabelsForComments(this.annotation) + '</div>');
    ...
    Editor.prototype.submit = function(event) {
        ...
        var tmp = this.annotation.subcorpusLabels;
        _.forEach(labels, function(b) {
            //console.log($(b).data());
