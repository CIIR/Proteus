...
public class PseudoDocument extends Document {
  ...
  public static PseudoDocument deserialize(byte[] data, PseudoDocumentComponents s) throws IOException {
    ByteArrayInputStream stream = new ByteArrayInputStream(data);
    DataInputStream dataIStream = new DataInputStream(stream);
    return deserialize(dataIStream, s);
  }

  public static PseudoDocument deserialize(DataInputStream dataIStream, PseudoDocumentComponents s) throws IOException {
    s.text = false;
  ...
  public static class PseudoDocumentComponents extends DocumentComponents {
    public boolean samples = true;
    public int sampleLimit = Integer.MAX_VALUE;
    
    public PseudoDocumentComponents(boolean text, boolean metadata, boolean tokenise, boolean samples) {
