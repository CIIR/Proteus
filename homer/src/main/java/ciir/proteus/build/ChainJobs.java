...
import static org.lemurproject.galago.core.tools.App.appFunctions;
 ...
 * @author jfoley
 */
public class ChainJobs extends AppFunction {
  ...
  private Parameters findJobParameters(Parameters step) throws IOException {
