            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.alternate_names = new ArrayList<String>(_list34.size);
                for (int _i35 = 0; _i35 < _list34.size; ++_i35)
                {
                  String _elem36; // required
                  _elem36 = iprot.readString();
                  struct.alternate_names.add(_elem36);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Organization struct) throws org.apache.thrift.TException {
      ...
      if (struct.alternate_names != null) {
        oprot.writeFieldBegin(ALTERNATE_NAMES_FIELD_DESC);
        {
          ...
          for (String _iter37 : struct.alternate_names)
          {
      ...
      if (struct.isSetAlternate_names()) {
        {
          ...
          for (String _iter38 : struct.alternate_names)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.alternate_names = new ArrayList<String>(_list39.size);
          for (int _i40 = 0; _i40 < _list39.size; ++_i40)
          {
            String _elem41; // required
            _elem41 = iprot.readString();
            struct.alternate_names.add(_elem41);
          }
        }
        struct.setAlternate_namesIsSet(true);
      }
