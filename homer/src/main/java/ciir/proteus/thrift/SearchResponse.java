            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new ArrayList<SearchResult>(_list130.size);
                for (int _i131 = 0; _i131 < _list130.size; ++_i131)
                {
                  SearchResult _elem132; // required
                  _elem132 = new SearchResult();
                  _elem132.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SearchResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (SearchResult _iter133 : struct.results)
          {
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (SearchResult _iter134 : struct.results)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.results = new ArrayList<SearchResult>(_list135.size);
          for (int _i136 = 0; _i136 < _list135.size; ++_i136)
          {
            SearchResult _elem137; // required
            _elem137 = new SearchResult();
            _elem137.read(iprot);
            struct.results.add(_elem137);
          }
        }
        struct.setResultsIsSet(true);
      }
