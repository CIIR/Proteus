            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.alternate_names = new ArrayList<String>(_list106.size);
                for (int _i107 = 0; _i107 < _list106.size; ++_i107)
                {
                  String _elem108; // required
                  _elem108 = iprot.readString();
                  struct.alternate_names.add(_elem108);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Location struct) throws org.apache.thrift.TException {
      ...
      if (struct.alternate_names != null) {
        oprot.writeFieldBegin(ALTERNATE_NAMES_FIELD_DESC);
        {
          ...
          for (String _iter109 : struct.alternate_names)
          {
      ...
      if (struct.isSetAlternate_names()) {
        {
          ...
          for (String _iter110 : struct.alternate_names)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.alternate_names = new ArrayList<String>(_list111.size);
          for (int _i112 = 0; _i112 < _list111.size; ++_i112)
          {
            String _elem113; // required
            _elem113 = iprot.readString();
            struct.alternate_names.add(_elem113);
          }
        }
        struct.setAlternate_namesIsSet(true);
      }
