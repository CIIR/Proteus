...
public class Video implements org.apache.thrift.TBase<Video, Video._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetLength_in_seconds() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LENGTH_IN_SECONDS_ISSET_ID);
  }
  ...
  public boolean isSetLength_in_seconds() {
    return EncodingUtils.testBit(__isset_bitfield, __LENGTH_IN_SECONDS_ISSET_ID);
  }

  public void setLength_in_secondsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LENGTH_IN_SECONDS_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_caption);
    if (present_caption)
      builder.append(caption);

    boolean present_coordinates = true && (isSetCoordinates());
    builder.append(present_coordinates);
    if (present_coordinates)
      builder.append(coordinates);

    boolean present_length_in_seconds = true && (isSetLength_in_seconds());
    builder.append(present_length_in_seconds);
    if (present_length_in_seconds)
      builder.append(length_in_seconds);
