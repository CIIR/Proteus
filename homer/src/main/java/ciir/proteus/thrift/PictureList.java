...
public class PictureList implements org.apache.thrift.TBase<PictureList, PictureList._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_pictures);
    if (present_pictures)
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pictures = new ArrayList<Picture>(_list82.size);
                for (int _i83 = 0; _i83 < _list82.size; ++_i83)
                {
                  Picture _elem84; // required
                  _elem84 = new Picture();
                  _elem84.read(iprot);
                  struct.pictures.add(_elem84);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PictureList struct) throws org.apache.thrift.TException {
      ...
      if (struct.pictures != null) {
        oprot.writeFieldBegin(PICTURES_FIELD_DESC);
        {
          ...
          for (Picture _iter85 : struct.pictures)
          {
            _iter85.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPictures()) {
        {
          ...
          for (Picture _iter86 : struct.pictures)
          {
            _iter86.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pictures = new ArrayList<Picture>(_list87.size);
          for (int _i88 = 0; _i88 < _list87.size; ++_i88)
          {
            Picture _elem89; // required
            _elem89 = new Picture();
            _elem89.read(iprot);
            struct.pictures.add(_elem89);
          }
        }
        struct.setPicturesIsSet(true);
      }
