...
public class RelatedRequest implements org.apache.thrift.TBase<RelatedRequest, RelatedRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_beliefs = true && (isSetBeliefs());
    builder.append(present_beliefs);
    if (present_beliefs)
      builder.append(beliefs);

    boolean present_target_types = true && (isSetTarget_types());
    builder.append(present_target_types);
    if (present_target_types)
      builder.append(target_types);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  SearchResult _elem148; // required
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            SearchResult _elem158; // required
