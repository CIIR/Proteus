            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.positions = new ArrayList<Integer>(_list210.size);
                for (int _i211 = 0; _i211 < _list210.size; ++_i211)
                {
                  int _elem212; // required
                  _elem212 = iprot.readI32();
                  struct.positions.add(_elem212);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.positions != null) {
        if (struct.isSetPositions()) {
          oprot.writeFieldBegin(POSITIONS_FIELD_DESC);
          {
            ...
            for (int _iter213 : struct.positions)
            {
      ...
      if (struct.isSetPositions()) {
        {
          ...
          for (int _iter214 : struct.positions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.positions = new ArrayList<Integer>(_list215.size);
          for (int _i216 = 0; _i216 < _list215.size; ++_i216)
          {
            int _elem217; // required
            _elem217 = iprot.readI32();
            struct.positions.add(_elem217);
          }
        }
        struct.setPositionsIsSet(true);
      }
