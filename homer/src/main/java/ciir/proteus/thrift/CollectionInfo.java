...
public class CollectionInfo implements org.apache.thrift.TBase<CollectionInfo, CollectionInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetNum_docs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUM_DOCS_ISSET_ID);
  }

  /** Returns true if field num_docs is set (has been assigned a value) and false otherwise */
  public boolean isSetNum_docs() {
    return EncodingUtils.testBit(__isset_bitfield, __NUM_DOCS_ISSET_ID);
  }

  public void setNum_docsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUM_DOCS_ISSET_ID, value);
  }
  ...
  public void unsetVocab_size() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __VOCAB_SIZE_ISSET_ID);
  }

  /** Returns true if field vocab_size is set (has been assigned a value) and false otherwise */
  public boolean isSetVocab_size() {
    return EncodingUtils.testBit(__isset_bitfield, __VOCAB_SIZE_ISSET_ID);
  }

  public void setVocab_sizeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __VOCAB_SIZE_ISSET_ID, value);
  }
  ...
  public void unsetNum_tokens() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUM_TOKENS_ISSET_ID);
  }

  /** Returns true if field num_tokens is set (has been assigned a value) and false otherwise */
  public boolean isSetNum_tokens() {
    return EncodingUtils.testBit(__isset_bitfield, __NUM_TOKENS_ISSET_ID);
  }

  public void setNum_tokensIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUM_TOKENS_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_num_docs = true;
    builder.append(present_num_docs);
    if (present_num_docs)
      builder.append(num_docs);

    boolean present_vocab_size = true;
    builder.append(present_vocab_size);
    if (present_vocab_size)
      builder.append(vocab_size);

    boolean present_num_tokens = true;
    builder.append(present_num_tokens);
    if (present_num_tokens)
