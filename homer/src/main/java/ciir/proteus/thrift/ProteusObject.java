...
public class ProteusObject implements org.apache.thrift.TBase<ProteusObject, ProteusObject._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField TOPIC_FIELD_DESC = new org.apache.thrift.protocol.TField("topic", org.apache.thrift.protocol.TType.STRUCT, (short)18);
  private static final org.apache.thrift.protocol.TField EXTERNAL_ENTITY_FIELD_DESC = new org.apache.thrift.protocol.TField("external_entity", org.apache.thrift.protocol.TType.STRUCT, (short)19);
  private static final org.apache.thrift.protocol.TField CONTEXTS_FIELD_DESC = new org.apache.thrift.protocol.TField("contexts", org.apache.thrift.protocol.TType.LIST, (short)50);
  ...
  public Topic topic; // optional
  public WikipediaEntity external_entity; // optional
  public List<KeywordsInContext> contexts; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TOPIC((short)18, "topic"),
    EXTERNAL_ENTITY((short)19, "external_entity"),
    CONTEXTS((short)50, "contexts");
  ...
  private _Fields optionals[] = {_Fields.TITLE,_Fields.DESCRIPTION,_Fields.IMG_URL,_Fields.THUMB_URL,_Fields.EXTERNAL_URL,_Fields.DATE_FREQ,_Fields.LANGUAGE_MODEL,_Fields.COLLECTION,_Fields.PAGE,_Fields.PICTURE,_Fields.VIDEO,_Fields.AUDIO,_Fields.PERSON,_Fields.LOCATION,_Fields.ORGANIZATION,_Fields.TOPIC,_Fields.EXTERNAL_ENTITY,_Fields.CONTEXTS};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXTERNAL_ENTITY, new org.apache.thrift.meta_data.FieldMetaData("external_entity", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, WikipediaEntity.class)));
    tmpMap.put(_Fields.CONTEXTS, new org.apache.thrift.meta_data.FieldMetaData("contexts", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, KeywordsInContext.class))));
  ...
  public ProteusObject(ProteusObject other) {
    ...
    if (other.isSetExternal_entity()) {
      this.external_entity = new WikipediaEntity(other.external_entity);
    }
    if (other.isSetContexts()) {
      List<KeywordsInContext> __this__contexts = new ArrayList<KeywordsInContext>();
      for (KeywordsInContext other_element : other.contexts) {
        __this__contexts.add(new KeywordsInContext(other_element));
      }
  ...
  public ProteusObject setTopic(Topic topic) {
    this.topic = topic;
    return this;
  }
  ...
  public WikipediaEntity getExternal_entity() {
    return this.external_entity;
  }

  public ProteusObject setExternal_entity(WikipediaEntity external_entity) {
    this.external_entity = external_entity;
    return this;
  }

  public void unsetExternal_entity() {
    this.external_entity = null;
  }

  /** Returns true if field external_entity is set (has been assigned a value) and false otherwise */
  public boolean isSetExternal_entity() {
    return this.external_entity != null;
  }

  public void setExternal_entityIsSet(boolean value) {
    if (!value) {
      this.external_entity = null;
    }
  }
  ...
  public java.util.Iterator<KeywordsInContext> getContextsIterator() {
    return (this.contexts == null) ? null : this.contexts.iterator();
  }

  public void addToContexts(KeywordsInContext elem) {
    if (this.contexts == null) {
      this.contexts = new ArrayList<KeywordsInContext>();
    }
    this.contexts.add(elem);
  }

  public List<KeywordsInContext> getContexts() {
    return this.contexts;
  }

  public ProteusObject setContexts(List<KeywordsInContext> contexts) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EXTERNAL_ENTITY:
      if (value == null) {
        unsetExternal_entity();
      } else {
        setExternal_entity((WikipediaEntity)value);
      }
      break;
    ...
    case CONTEXTS:
      if (value == null) {
        ...
        setContexts((List<KeywordsInContext>)value);
      }
      break;
  ...
  public boolean equals(ProteusObject that) {
    ...
    boolean this_present_external_entity = true && this.isSetExternal_entity();
    boolean that_present_external_entity = true && that.isSetExternal_entity();
    if (this_present_external_entity || that_present_external_entity) {
      if (!(this_present_external_entity && that_present_external_entity))
        return false;
      if (!this.external_entity.equals(that.external_entity))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_date_freq = true && (isSetDate_freq());
    builder.append(present_date_freq);
    if (present_date_freq)
      builder.append(date_freq);

    boolean present_language_model = true && (isSetLanguage_model());
    builder.append(present_language_model);
    if (present_language_model)
      builder.append(language_model);
    ...
    builder.append(present_video);
    if (present_video)
      builder.append(video);

    boolean present_audio = true && (isSetAudio());
    builder.append(present_audio);
    if (present_audio)
    ...
    boolean present_external_entity = true && (isSetExternal_entity());
    builder.append(present_external_entity);
    if (present_external_entity)
      builder.append(external_entity);
  ...
  public int compareTo(ProteusObject other) {
    ...
    lastComparison = Boolean.valueOf(isSetExternal_entity()).compareTo(typedOther.isSetExternal_entity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExternal_entity()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.external_entity, typedOther.external_entity);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetContexts()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.contexts, typedOther.contexts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetExternal_entity()) {
      if (!first) sb.append(", ");
      sb.append("external_entity:");
      if (this.external_entity == null) {
        sb.append("null");
      } else {
        sb.append(this.external_entity);
      }
      first = false;
    }
    if (isSetContexts()) {
  ...
  private static class ProteusObjectStandardScheme extends StandardScheme<ProteusObject> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ProteusObject struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 19: // EXTERNAL_ENTITY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.external_entity = new WikipediaEntity();
              struct.external_entity.read(iprot);
              struct.setExternal_entityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contexts = new ArrayList<KeywordsInContext>(_list122.size);
                for (int _i123 = 0; _i123 < _list122.size; ++_i123)
                {
                  KeywordsInContext _elem124; // required
                  _elem124 = new KeywordsInContext();
                  _elem124.read(iprot);
                  struct.contexts.add(_elem124);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProteusObject struct) throws org.apache.thrift.TException {
      ...
      if (struct.external_entity != null) {
        if (struct.isSetExternal_entity()) {
          oprot.writeFieldBegin(EXTERNAL_ENTITY_FIELD_DESC);
          struct.external_entity.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      if (struct.contexts != null) {
        if (struct.isSetContexts()) {
          oprot.writeFieldBegin(CONTEXTS_FIELD_DESC);
          {
            ...
            for (KeywordsInContext _iter125 : struct.contexts)
            {
      ...
      if (struct.isSetContexts()) {
        {
          ...
          for (KeywordsInContext _iter126 : struct.contexts)
          {
      ...
      if (incoming.get(19)) {
        {
          ...
          struct.contexts = new ArrayList<KeywordsInContext>(_list127.size);
          for (int _i128 = 0; _i128 < _list127.size; ++_i128)
          {
            KeywordsInContext _elem129; // required
            _elem129 = new KeywordsInContext();
            _elem129.read(iprot);
            struct.contexts.add(_elem129);
          }
        }
        struct.setContextsIsSet(true);
      }
