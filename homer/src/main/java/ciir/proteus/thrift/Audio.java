            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.creators = new ArrayList<String>(_list66.size);
                for (int _i67 = 0; _i67 < _list66.size; ++_i67)
                {
                  String _elem68; // required
                  _elem68 = iprot.readString();
                  struct.creators.add(_elem68);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Audio struct) throws org.apache.thrift.TException {
      ...
      if (struct.creators != null) {
        oprot.writeFieldBegin(CREATORS_FIELD_DESC);
        {
          ...
          for (String _iter69 : struct.creators)
          {
      ...
      if (struct.isSetCreators()) {
        {
          ...
          for (String _iter70 : struct.creators)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.creators = new ArrayList<String>(_list71.size);
          for (int _i72 = 0; _i72 < _list71.size; ++_i72)
          {
            String _elem73; // required
            _elem73 = iprot.readString();
            struct.creators.add(_elem73);
          }
        }
        struct.setCreatorsIsSet(true);
      }
