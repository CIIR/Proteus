 ...
 * searches around that year for a month name. A year is sufficient to emit a
 * date. Day of the month is currently not supported.
 *
 * @author trevor
 */
@InputClass(className = "org.lemurproject.galago.core.parse.Document")
@OutputClass(className = "org.lemurproject.galago.core.types.DateExtent")
public final class DateExtractor extends StandardStep<Document, Document> {
